...
function SWEP:Initialize()
	if SERVER then
		...
		chat.AddText(Color(255, 62, 62), "NSZ NOTICE: This SWEP is deprecated and will be removed in a future update. Please use the new tool to the right on the spawn menu.")
